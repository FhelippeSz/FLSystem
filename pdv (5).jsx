  ...
  return (
    <Card style={{ marginBottom: 16, textAlign: 'center' }}>
      <div style={{ fontSize: 12, color: C.muted, marginBottom: 10 }}>
        O cliente escaneia o QR abaixo — o valor de <strong style={{ color: C.textDark }}>{fmt(valor)}</strong> já vem preenchido e cai direto na chave <span style={{ fontFamily: "'JetBrains Mono',monospace" }}>{config.chavePix}</span>.
      </div>
